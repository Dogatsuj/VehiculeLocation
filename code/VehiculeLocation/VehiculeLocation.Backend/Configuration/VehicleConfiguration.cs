...
namespace VehiculeLocation.Backend.Data.Configuration
{
    ...
    public class VehicleConfiguration : IEntityTypeConfiguration<Vehicle>
    {
        public void Configure(EntityTypeBuilder<Vehicle> builder)
        {
            ...
            builder.Property(v => v.Model).IsRequired().HasMaxLength(50); // Exemple de contrainte
            builder.Property(v => v.Seats).IsRequired();
            builder.Property(v => v.DailyRentalPrice).IsRequired(); // Assure que le prix est requis
            builder.Property(v => v.IsAutomaticTransmission).IsRequired(); // Assure que la transmission est requise
